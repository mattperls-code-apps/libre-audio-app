...
const SearchTab = ({ navigation }) => {
  ...
  const handleEndEditing = (e) => {
    ...
    const videos = getSearchResults(newQuery)
  ...
  return (
    <View style={styles.page}>
      ...
      {!loading ? <FlatList showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 58 }} data={songItems} ListHeaderComponent={() => {
        return (
